              ...
              <div className="w-full max-w-xs lg:max-w-sm">
                <div className="bg-gray-50 border border-gray-100 rounded-3xl p-7 shadow-sm">
                  <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                    <div className="w-16 h-16 bg-sky-100 border-2 border-sky-200 rounded-2xl flex items-center justify-center flex-shrink-0">
                      <Stethoscope className="w-8 h-8 text-sky-600" />
                    </div>
                    <div>
                      <div className="text-base font-bold text-gray-900">Dr. Saria El Hachem</div>
                      <div className="text-sm text-sky-600 font-medium mt-0.5">Family Medicine</div>
                      <div className="text-xs text-gray-400 mt-0.5">Jumeirah American Clinic · Dubai</div>
                    </div>
                  </div>
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={label} className="flex items-center gap-3 bg-white border border-gray-100 rounded-xl px-4 py-2.5">
