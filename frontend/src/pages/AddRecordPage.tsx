    ...
    return (
      <div className="min-h-screen text-gray-900">
        ...
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-500 mb-6">The medical record has been saved successfully for {patient?.first_name} {patient?.last_name}.</p>
    ...
    <div className="min-h-screen text-gray-900">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button onClick={goBack} className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-gray-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {bloodRows.map((row, i) => (
                  <div key={i} className="grid grid-cols-6 gap-2 items-end">
                    <div className="col-span-2">
                      {i === 0 && <label className="label text-xs text-gray-600">Test Name</label>}
                    ...
                    <div>
                      {i === 0 && <label className="label text-xs text-gray-600">Value</label>}
                    ...
                    <div>
                      {i === 0 && <label className="label text-xs text-gray-600">Unit</label>}
                    ...
                    <div>
                      {i === 0 && <label className="label text-xs text-gray-600">Status</label>}
                    ...
                    <div>
                      {i === 0 && <label className="label text-xs text-gray-600">&nbsp;</label>}
                      {bloodRows.length > 1 && (
          ...
          <div className="card">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                <label className="block border-2 border-dashed border-gray-200 rounded-xl p-6 text-center cursor-pointer hover:border-sky-300 hover:bg-sky-50 transition-colors">
                  <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                  <p className="text-sm text-gray-700 font-medium">{uploadFile ? uploadFile.name : 'Click to upload or drag & drop'}</p>
